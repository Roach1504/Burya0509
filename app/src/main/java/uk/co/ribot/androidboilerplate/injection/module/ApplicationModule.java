...
public class ApplicationModule {
    ...
    ListCommentsServise listCommentsServise() {
        return ListCommentsServise.Creator.listCommentsServise();
    }

    @Provides
    @Singleton
    AddCommentServise addCommentServise() {
        return AddCommentServise.Creator.addCommentServise();
    }

    @Provides
    @Singleton
    SendMessageServise sendMessageServise() {
        return SendMessageServise.Creator.sendMessageServise();
    }
